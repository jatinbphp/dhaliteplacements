...
@section('js')
    <script>
        $(document).ready(function () {
            $(document).on('click', '.delete-btn', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('deleteCCompany', { companyId: companyId });
            ...
            Livewire.on('cCompanyDeleted', function () {
                $('#c-Company').DataTable().ajax.reload(null, false);
            });
        });
    </script>
@endsection
